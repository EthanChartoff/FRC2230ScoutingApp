...
class Routing {
  ...
  static const MATCHES_SCOUTING_FORM = 'scouting-form'; 
...
//     if(route!.startsWith(Routing.MATCHES)) {
//       //Navigator.pushNamed(context, Routing.MATCHES);
//       page = _onMatchesRoutes(settings.name!);
//     }

//     else if(route.startsWith(Routing.TEAM_VIEW)) {
//       page = DesktopSidemenuScreenBuilder(
//         screen: Dashboard(
//           teamNumber: int.parse(route.substring(Routing.TEAM_VIEW.length))
//         ),
//       );
//     }
